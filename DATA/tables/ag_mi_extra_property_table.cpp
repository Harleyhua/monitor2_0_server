...
bool ag_mi_extra_property_table::r_temporary_power(QSqlDatabase &m_database, QString mi_cid, QString &temporary_power)
{
...
bool ag_mi_extra_property_table::r_max_power(QSqlDatabase &m_database, QString mi_cid, QString &max_power)
{
    QString tmp_cmd = QString("SELECT %1 FROM %2 WHERE %3='%4' ")
...
bool ag_mi_extra_property_table::r_grid(QSqlDatabase &m_database, QString mi_cid, QString &grid)
{
    QString tmp_cmd = QString("SELECT %1 FROM %2 WHERE %3='%4' ")
...
bool ag_mi_extra_property_table::r_certification(QSqlDatabase &m_database, QString mi_cid, QString &certification)
{
    QString tmp_cmd = QString("SELECT %1 FROM %2 WHERE %3='%4' ")
